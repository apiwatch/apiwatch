...
/*CPPParser__*/qualifiedItemIs(int lookahead_offset)
	...
	//	k,(LT(k)->getText(LT(k)))->chars,LT(k)->getType(),isTypeName((LT(k)->getText(LT(k)))->chars),isClassName((LT(k)->getText(LT(k)))->chars), inputState->guessing);
...
void /*CPPParser__*/declaratorID(pANTLR3_UINT8 _id,QualifiedItem qi)
	{
