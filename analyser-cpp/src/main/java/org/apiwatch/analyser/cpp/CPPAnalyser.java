...
public class CPPAnalyser implements LanguageAnalyser {

    private static final String PREPROCESSOR_CMD_OPTION = "cpp_preprocessor_cmd";
    private static final String SYSTEM_INCLUDE_PATHS_OPTION = "cpp_system_include_paths";
    private static final String[] FILE_EXTENSIONS = { "cpp" };
    private static final String LANGUAGE = "C++";
    private static final String DEFAULT_PREPROCESSOR_CMD = "c++ -E";
            ...
            ParseError
    {
        ...
        try {
            CPPLexer lexer = new CPPLexer(input, systemPaths);
